  ...
  return (
    <footer className="relative bg-[#0A0A0B] pt-32 pb-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start border-b border-white/10 pb-20">
          ...
          <div className="lg:col-span-6 space-y-16">
            ...
            >
              <h4 className="text-white font-serif text-xl mb-6 italic">Subscribe for Literary Insights</h4>
              <form className="relative flex items-center">
                <input 
                  type="email" 
                  placeholder="Your Email Address" 
                  className="w-full bg-transparent border-b border-white/10 py-4 text-white placeholder:text-gray-600 focus:outline-none focus:border-primary transition-all duration-500"
                />
                <button 
                  type="submit" 
                  className="absolute right-0 p-2 text-primary hover:text-white transition-colors"
                >
